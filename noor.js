const translations = {
    en: {
        ...
        computer_title: "Computer Solutions", 
        computer_desc: "Professional computer services and high-end equipment.",
        ...
        fiber_p1_title: "Bandwidth", fiber_p1_desc: "Significantly higher bandwidth compared to copper cables. Ideal for heavy data usage.",
        fiber_p2_title: "Distance", fiber_p2_desc: "Transmit data over long distances with minimal signal loss.",
        fiber_p3_title: "Reliability", fiber_p3_desc: "Immune to electromagnetic interference, ensuring a stable connection.",
        fiber_services_title: "Our Services",
        fiber_srv_1: "Indoor Termination", fiber_srv_2: "Fusion Splicing",
        fiber_srv_3: "OTDR Testing & Reporting", fiber_srv_4: "Data Center Cabling",
    ...
    tr: {
        ...
        computer_title: "Bilgisayar Çözümleri", 
        computer_desc: "Profesyonel bilgisayar hizmetleri ve üst düzey ekipmanlar.",
        ...
        fiber_p1_title: "Bant Genişliği", fiber_p1_desc: "Bakır kablolara kıyasla çok daha yüksek bant genişliği. Yoğun veri kullanımı için idealdir.",
        fiber_p2_title: "Mesafe", fiber_p2_desc: "Verileri minimum sinyal kaybıyla uzun mesafelere iletin.",
        fiber_p3_title: "Güvenilirlik", fiber_p3_desc: "Elektromanyetik parazitlere karşı bağışıktır ve istikrarlı bir bağlantı sağlar.",
        fiber_services_title: "Hizmetlerimiz",
        fiber_srv_1: "Bina İçi Sonlandırma", fiber_srv_2: "Füzyon Ek (Splicing)",
        fiber_srv_3: "OTDR Test ve Raporlama", fiber_srv_4: "Veri Merkezi Kablolama",
    ...
    ar: {
        ...
        computer_title: "حلول الكمبيوتر", 
        computer_desc: "خدمات كمبيوتر احترافية ومعدات عالية الجودة.",
        ...
        fiber_p1_title: "عرض النطاق الترددي", fiber_p1_desc: "عرض نطاق ترددي أعلى بكثير مقارنة بالكابلات النحاسية. مثالي للاستخدام الكثيف للبيانات.",
        fiber_p2_title: "المسافة", fiber_p2_desc: "نقل البيانات لمسافات طويلة مع الحد الأدنى من فقدان الإشارة.",
        fiber_p3_title: "الموثوقية", fiber_p3_desc: "محصن ضد التداخل الكهرومغناطيسي، مما يضمن اتصالاً مستقراً.",
        fiber_services_title: "خدماتنا",
        fiber_srv_1: "التوصيلات الداخلية", fiber_srv_2: "الربط الانصهاري (Splicing)",
        fiber_srv_3: "اختبار OTDR وإصدار التقارير", fiber_srv_4: "كابلات مراكز البيانات",
    ...
    ku: {
        ...
        computer_title: "چارەسەرەکانی کۆمپیوتەر", 
        computer_desc: "خزمەتگوزاری پیشەیی کۆمپیوتەر و ئامێری ئاست بەرز.",
        ...
        fiber_p1_title: "فراوانی هێڵ", fiber_p1_desc: "توانای زۆر زیاتر بەراورد بە کەیبڵی مس. گونجاوە بۆ بەکارهێنانی زۆری داتا.",
        fiber_p2_title: "مەودا", fiber_p2_desc: "گواستنەوەی داتا بۆ مەودای دوور بە کەمترین لەدەستدانی نیشانە.",
        fiber_p3_title: "متمانەپێکراوی", fiber_p3_desc: "پارێزراوە لە تێکچوونی کارۆموگناتیسی، بۆ مسۆگەرکردنی پەیوەندییەکی جێگیر.",
        fiber_services_title: "خزمەتگوزارییەکانمان",
        fiber_srv_1: "بەستنی ناوەوە", fiber_srv_2: "لکاندنی فایبەر (Splicing)",
        fiber_srv_3: "پشکنین و ڕاپۆرتی OTDR", fiber_srv_4: "کەیبڵکردنی داتا سەنتەر",
...
/* =========================================
   --- MİNİMAL DARK MODE İKON KONTROLÜ ---
   ========================================= */
...
function updateThemeIcon(isDark) {
    ...
    if (isDark) {
        // Gece modundaysak Güneş İkonunu göster
        icon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />';
    } else {
        // Gündüz modundaysak Ay İkonunu göster
        icon.innerHTML = '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />';
    }
}

// Sayfa yüklendiğinde son seçimi hatırla
document.addEventListener('DOMContentLoaded', () => {
